...
<script type="text/javascript">
	...
	function removeDraft(obj) {
		...
		setTimeout(function(){ 
			$(location).attr('href', "ospedale.jsp");
		}, 200);
		//var url = "ospedale.jsp";
  ...
  <div class="page-container">
    ...
    <div class="main-content">
          ...
          <div class="col-sm-8">
            <div class="breadcrumbs-area clearfix">
              ...
              <ul class="breadcrumbs pull-left">
                ...
                <li><span>Gestione Ospedali</span></li>
              </ul>
            </div>
          </div>
      ...
      <div class="main-content-inner">
        ...
        <div class="row">
          <div class="col-12 mt-5">
            <div class="card">
              <div class="card-body">
                <h4 class="header-title">Ospedali</h4>
                  ...
                  <div class="table-responsive">
                    <form method="post">
                      <div id="alertDelete" hidden=true; class="alert alert-danger" role="alert">
                        ...
                        <p>
                          Sei sicuro di voler eliminare l'ospedale <span id="id_domanda"></span>?
                        </p>
                        <hr>
                        <div align="center">
                      ...
                      <table class="table table-hover progress-table text-center sortable">
                        ...
                        <tbody>
                          ...
                          %>
                          <tr id=<%=ospedali.getEmail()%>>
                            <th scope="row"><%=i%></th>
                            <!--  td><%=ospedali.getId()%></td-->
                            <td><%=ospedali.getNome()%></td>
                            <td><%=ospedali.getIndirizzo()%></td>
                            <td><%=ospedali.getEmail()%> <input hidden="true" name="email" value="<%=ospedali.getEmail()%>" id="email" type="text"></td>
                            <td><%=ospedali.getTelefono()%><br><%=ospedali.getTelefono1()%></td>
                            <td>
                              <ul class='d-flex justify-content-center'>
                                <li class='mr-3'><a id="modifica" href="modificaOspedale.jsp?email=<%=ospedali.getEmail()%>" class='text-secondary'><i class='fa fa-edit' title="Modifica"></i></a></li>
                                <li><a id="elimina" style="cursor: pointer;" class='text-secondary' onclick="confermaAlertPassword('<%=ospedali.getEmail()%>', '<%=ospedali.getId()%>','<%=ospedali.getNome()%>')"><i class='fas fa-trash-alt' title="Elimina"></i></a></li>
                              </ul>
                            </td>
                          </tr>
                          <%
                      ...
                      <div style="text-align: center;">
                        ...
                        <p>
                          <span style="color: orange;"><b>Attenzione.</b> Nessun ospedale &egrave; stato inserito</span>
                        </p>
                      </div>
                      <%
                      	}
      ...
      <div class="form-group">
        <button type="button" class="btn btn-primary btn-lg btn-block" onclick="window.location.href='./inserisciOspedale.jsp'">Inserisci nuovo ospedale</button>
