  ...
  <div class="page-container">
    ...
    <div class="main-content">
          ...
          <div class="col-sm-8">
            <div class="breadcrumbs-area clearfix">
              ...
              <ul class="breadcrumbs pull-left">
                ...
                <li><span>Gestione Servizi Antiviolenza</span></li>
              </ul>
            </div>
          </div>
      ...
      <div class="main-content-inner">
        ...
        <div class="row">
          <div class="col-12 mt-5">
            <div class="card">
              <div class="card-body">
                <h4 class="header-title">Servizi Antiviolenza</h4>
                  ...
                  <div class="table-responsive">
                    <form method="post">
                      <div id="alertDelete" hidden=true; class="alert alert-danger" role="alert">
                        ...
                        <p>
                          Sei sicuro di voler eliminare il servizio antiviolenza <span id="id_domanda"></span>?
                        </p>
                        <hr>
                        <div align="center">
                      ...
                      <table class="table table-hover progress-table text-center sortable">
                        ...
                        <tbody>
                          ...
                          for (CavsModel strutture : cavs) {
                          %>
                          <tr id="<%=strutture.getEmail()%>">
                            <th scope="row"><%=i%></th>
                            <td><%=strutture.getId()%></td>
                            <td><%=strutture.getNome()%></td>
                            <td><%=strutture.getIndirizzo()%></td>
                            <td><%=strutture.getEmail()%> <input hidden="true" name="email" value="<%=strutture.getEmail()%>" id="email" type="text"></td>
                            <td><%=strutture.getTelefono()%><br><%=strutture.getTelefono1()%></td>
                            <td>
                              <ul class='d-flex justify-content-center'>
                                <li class='mr-3'><a id="modifica" href="modificaCav.jsp?email=<%=strutture.getEmail()%>" class='text-secondary'><i class='fa fa-edit' title="Modifica"></i></a></li>
                                <li><a id="elimina" style="cursor: pointer;" class='text-secondary' onclick="confermaAlertPassword('<%=strutture.getEmail()%>', '<%=strutture.getId()%>', '<%=strutture.getNome()%>')"><i class='fas fa-trash-alt' title="Elimina"></i></a></li>
                              </ul>
                            </td>
                          </tr>
                          <%
                      ...
                      <div style="text-align: center;">
                        ...
                        <p>
                          <span style="color: orange;"><b>Attenzione.</b> Nessun servizio antiviolenza &egrave; stato inserito</span>
                        </p>
                      </div>
                      <%
                      	}
      ...
      <div class="form-group">
        <button type="button" class="btn btn-primary btn-lg btn-block" onclick="window.location.href='./inserisciCav.jsp'">Inserisci nuovo servizio antiviolenza</button>
        <button type="button" class="btn btn-secondary btn-lg btn-block" onclick="window.location.href='./strutture.jsp'">Indietro</button>
      </div>
    </div>
