	...
	function load() {
		...
		$.ajax({
			...
			success : function(jsonStr) {
				$('#id_ospedale').val(jsonStr['id']);
				$('#email_ospedale').val(jsonStr['email']);
				$('#indirizzo_ospedale').val(jsonStr['indirizzo']);
				$('#telefono_ospedale').val(jsonStr['telefono']);
				$('#telefono1_ospedale').val(jsonStr['telefono1']);
				$('#nome_ospedale').val(jsonStr['nome']);
			}
		});
	}
          ...
          <div class="col-sm-8">
            <div class="breadcrumbs-area clearfix">
              ...
              <ul class="breadcrumbs pull-left">
                ...
                <li><span>Modifica Ospedale</span></li>
              </ul>
            </div>
          </div>
              ...
              <div class="card-body">
                ...
                <form method="post">
                  ...
                  <div class="form-group">
                    <!--  label>Id Ospedale&nbsp;<span id="id_ospedale_error_msg" style="color: red;"></span></label--> 
                    <input type="hidden" readonly id="id_ospedale" name="id_struttura" class="form-control" value="">    
                    ...
                    <label>Email&nbsp;<span id="email_ospedale_error_msg" style="color: red;"></span></label> <input readonly id="email_ospedale" name="email" class="form-control" value=""> 
