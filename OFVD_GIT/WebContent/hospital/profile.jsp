...
<script type="text/javascript">
	...
	function load_data() {
		...
		user.matricola = $('#matricolaUserHospital').val();
		user.codeHospital = $('#codeHospital').val();
		user.codeAdminCav = $('#codeAdminHospital').val();
              ...
              <div class="card-body">
                <form action="">
                  ...
                  <div class="form-group">
                    ...
                    <label>Matricola</label> <input class="form-control" placeholder="<%=account.getMatricola()%>" readonly id="matricolaUserHospital" value="<%=account.getMatricola()%>"> 
                    <label>Codice Ospedale</label> <input class="form-control" placeholder="<%=account.getHospital()%>" readonly id="codeHospital"
                      value="<%=account.getHospital()%>"
                    > <label>Codice Admin</label> <input class="form-control" placeholder="<%=account.getAdmin()%>" readonly id="codeAdminHospital" value="<%=account.getAdmin()%>"> <label>Password</label> <input type="password" class="form-control" placeholder="Inserisci una nuova Password" id="passwordUserHospital" value=""> <label>Ripeti Password</label> <input type="password" class="form-control" placeholder="Ripeti la nuova Password" id="newPasswordUserHospital" value="">
                  </div>
                </form>
              </div>
            </div>
