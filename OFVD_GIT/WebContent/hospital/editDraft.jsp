...
<script type="text/javascript">
	...
	function load() {
		...
		question1.action = "editDraft";
		question1.answer1 = "" + q_id;
		...
		var request = $
				.ajax({
					...
					type : "GET",
					data : {
						elements : JSON.stringify(question1)
					},
					dataType : "JSON",
					...
					success : function(jsonStr) {
						...
						$('#identificativo_scheda').val(identificativoScheda);
						$('#id_scheda').text(identificativoScheda);
						$('#data_compilazione').val(dataCompilazione);
						$('#hospital_name_select').val(prontoSoccorso);
						...
						if (comune_nascita_select == ""
							...
							$('#comune_nascita_select').val(comune_nascita_select);
						*/
						...
						$(
								"input[name='cittadinanza'][value='"
										+ cittadinanza_italiana + "']").attr(
								"checked", "true");

						if (altraCittadinanza == ""
								|| altraCittadinanza == undefined)
							$("#cittadinanza_select").val("Scegli...");
						else
							$("#cittadinanza_select").val(altraCittadinanza);
						...
						$(
								"input[name='conviventi_maschi'][value='"
										+ conviventi + "']").attr("checked",
								"true");
						...
						if (selectTitoloDiStudio == ""
							...
							$("#selectTitoloDiStudio").val(titoloDiStudio);
						...
						if (selectProfessione == ""
							...
							$("#selectProfessione").val(professione);
						...
						$(
								"input[name='primo_accesso_ps'][value='"
										+ primoAccessoProntoSoccorso + "']")
								.attr("checked", "true");

						$("#numero_accessi_ripetuti")
								.val(numeroAccessiRipetuti);
						...
						if(sfruttamento != null && sfruttamento != undefined) {
							...
							$("input[name='sfruttamento'][value='"
											+ sfruttamentoItem[i] + "']").attr("checked", "true");
							}
						}	

						$(
								"input[name='con_figli_minori'][value='"
										+ con_figli_minori + "']").attr(
								"checked", "true");

						$("#selectDonnaAccompagnataInPS").val(
								donnaAccompagnataInPS);

						$("#altroDonnaAccompagnataInPS").val(
								altroDonnaAccompagnataInPS);

						$("#motivoAccessoInPS").val(motivoAccessoInPS);

						$(
								"input[name='codiceAttribuito'][value='"
										+ codiceAttribuito + "']").attr(
								"checked", "true");
						...
						if (provinciaNascitaPresuntoAutore == "")
							$("#provincia_nascita_presunto_aggressore_select")
									.val("Scegli...");
						else
							$("#provincia_nascita_presunto_aggressore_select")
									.val(provinciaNascitaPresuntoAutore);

						
						if (comuneNascitaPresuntoAutore == "" || comuneNascitaPresuntoAutore == undefined) {
							$("#comune_nascita_presunto_aggressore_select")
									.val("Scegli...");
						} else {
							addComuniPresunto(comuneNascitaPresuntoAutore);
						}						
						/*
						if (comuneNascitaPresuntoAutore == "" || comuneNascitaPresuntoAutore == undefined) {
							$("#comune_nascita_presunto_aggressore_select")
							...
							addComuniPresunto();
							$("#comune_nascita_presunto_aggressore_select")
									.val(comuneNascitaPresuntoAutore);
						}*/
						...
						if (titoloDiStudioPresuntoAutore == "")
						...
						if (tipologiaFamiliare == "")
							$("#tipologia_familiare").val("Scegli...");
						else
							$("#tipologia_familiare").val(tipologiaFamiliare);
						...
						$(
								"input[name='aggressore_servizi'][value='"
										+ presuntoAutoreServizi + "']").attr(
								"checked", "true");

						if (tipologiaServiziPresuntoAutore == "")
						...
						$(
								"input[name='brief_risk_1'][value='"
										+ briefRisk1 + "']").attr("checked",
								"true");

						$(
								"input[name='brief_risk_2'][value='"
										+ briefRisk2 + "']").attr("checked",
								"true");

						$(
								"input[name='brief_risk_3'][value='"
										+ briefRisk3 + "']").attr("checked",
								"true");

						$(
								"input[name='brief_risk_4'][value='"
										+ briefRisk4 + "']").attr("checked",
								"true");

						$(
								"input[name='brief_risk_5'][value='"
										+ briefRisk5 + "']").attr("checked",
								"true");

						$(
								"input[name='brief_risk_6'][value='"
										+ briefRisk6 + "']").attr("checked",
								"true");

						$(
								"input[name='brief_risk_7'][value='"
										+ briefRisk7 + "']").attr("checked",
								"true");

						$("#rete_intra_ospedaliera").val(reteIntraOspedaliera);

						$("#specifico_rete_intra_ospedaliera").val(
								specificoReteIntraOspedaliera);

						$("#rete_extra_ospedaliera").val(reteExtraOspedaliera);

						$("#specifico_rete_extra_ospedaliera").val(
								specificoReteExtraOspedaliera);

						$(
								"input[name='forze_dell_ordine'][value='"
										+ forzeDellOrdine + "']").attr(
								"checked", "true");

						$("#tempi_di_prognosi").val(tempiDiPrognosi);

						$("input[name='referto'][value='" + referto + "']")
								.attr("checked", "true");

						$(
								"input[name='attestazioni'][value='"
										+ attestazioni + "']").attr("checked",
								"true");

						$(
								"input[name='codiceRosa'][value='" + codiceRosa
										+ "']").attr("checked", "true");

						//ho modificato da qua..

						if ($('input:radio[name=cittadinanza]:checked').val() == 'Si') {
							$('#cittadinanza_select').hide();
						} else if ($('input:radio[name=cittadinanza]:checked')
								.val() == 'No') {
							$('#cittadinanza_select').show();
						} else if ($('input:radio[name=cittadinanza]:checked')
								.val() == 'Dato non dichiarato') {
							$('#cittadinanza_select').hide();
						}

						if ($('input:radio[name=primo_accesso_ps]:checked')
								.val() == 'Si') {
							$('#accessi_ripetuti').hide();
						}
						if ($('input:radio[name=primo_accesso_ps]:checked')
							...
							$('#accessi_ripetuti').show();
								...
								'input:radio[name=primo_accesso_ps]:checked')
								.val() == 'Dato non dichiarato') {
							$('#accessi_ripetuti').hide();
						}

						if ($(
								'input:radio[name=select_lingua_italiana]:checked')
								.val() == 'No') {
						...
						if ($('#selectDonnaAccompagnataInPS option:checked')
								.text() == 'Altro...') {
						...
						if ($('input:radio[name=figli]:checked').val() == 'Si') {
							$('#div_eta_figli').show();
						} else {
							$('#div_eta_figli').hide();
						}
						if ($("input:radio[name=aggressore_servizi]:checked")
								.val() == 'Si') {
							$('#div_tipologia_servizi_aggressore').show();
						} else {
							$('#div_tipologia_servizi_aggressore').hide();
						}

						if ($('#selectTitoloDiStudio option:checked').text() == 'Altro...') {
							$('#div_altroTitoloDiStudio').show();
						} else {
							$('#div_altroTitoloDiStudio').hide();
						}

						if ($('#selectTitoloDiStudioAggressore option:checked')
								.text() == 'Altro...') {
						...
						if ($(
								'#rapporto_vittima_autore_violenza option:checked')
								.text() == 'Familiare') {
							$('#div_familiare').show();
						} else {
							$('#div_familiare').hide();
						...
						if ($(
								'#rapporto_vittima_autore_violenza option:checked')
								.text() == 'Altro...') {
							$('#div_altroRapportoVittimaAggressore').show();
						} else {
							$('#div_altroRapportoVittimaAggressore').hide();
						}

						if ($('#tipologia_servizi_aggressore option:checked')
								.text() == 'Altro...') {
							$('#div_altroTipologiaServiziAggressore').show();
						} else {
							$('#div_altroTipologiaServiziAggressore').hide();
						}

						if ($('#rete_intra_ospedaliera option:checked').text() == 'Altro...') {
							$('#div_specifico_rete_intra_ospedaliera').show();
						} else {
							$('#div_specifico_rete_intra_ospedaliera').hide();
						}

						if ($('#rete_extra_ospedaliera option:checked').text() == 'Altro...') {
							$('#div_specifico_rete_extra_ospedaliera').show();
						} else {
							$('#div_specifico_rete_extra_ospedaliera').hide();
						}

						if ($('#rete_extra_ospedaliera option:checked').text() == "Forze dell'Ordine") {
	...
	$(document).ready(function() {
		...
		$('input:radio[name=primo_accesso_ps]').change(function() {
			if (this.value == 'Si') {
				$('#accessi_ripetuti').hide();
		...
		$("input:radio[name=aggressore_servizi]").change(function() {
			if (this.value == 'Si') {
				$('#div_tipologia_servizi_aggressore').show();
			} else {
				$('#div_tipologia_servizi_aggressore').hide();
		...
		$('#rapporto_vittima_autore_violenza').change(function() {
		...
		$('#tipologia_familiare').change(function() {
			if (this.value == 'Altro...') {
				$('#div_altroRapportoVittimaAggressore').show();
			} else {
				$('#div_altroRapportoVittimaAggressore').hide();
		...
		$('#tipologia_servizi_aggressore').change(function() {
			if (this.value == 'Altro...') {
				$('#div_altroTipologiaServiziAggressore').show();
			} else {
				$('#div_altroTipologiaServiziAggressore').hide();
		...
		$('#rete_intra_ospedaliera').change(function() {
			if (this.value == 'Altro...') {
				$('#div_specifico_rete_intra_ospedaliera').show();
			} else {
				$('#div_specifico_rete_intra_ospedaliera').hide();
	...
	function question2() {
		...
		if (re.test($('#nome_vittima').val())) {
			...
			if ($('#nome_vittima').val() == "")
				...
				$('#nome_vittima_error_msg')
						.text(
								"Gentilmente, compila il campo con caratteri alfabetici");
			...
			$
					.ajax({
						...
						success : function(jsonStr) {
							...
							if (comune == "" || comune == undefined)
								$('#comune_nascita_presunto_aggressore_select').val("Scegli...");
							else							
							$("#comune_nascita_presunto_aggressore_select").val(comune);
						}
					});
...
<body onLoad="load();">
  ...
  <div class="page-container">
    ...
    <div class="main-content">
      ...
      <div id="myModalError" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="false">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">
                Attenzione <span id="id_scheda"></span>
              </h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            ...
            <div class="modal-body">
              <p style="text-align: center">
                <img src="../assets/images/media/loading.gif" width="50%" height="50%" />
              </p>
              <p id="alert_dialog" style="text-algin: center; color: orange;">
                Uno o pi&ugrave; campi sono vuoti<br /> Gentilmente, compila l'intero modulo prima di proseguire
              </p>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-primary" data-dismiss="modal">Ok</button>
                ...
                <form action="">
                  ...
                  <div id="nucleoFamiliare">
                    ...
                    <div class="form-group" id="div_eta_figli">
                      ...
                      <!-- 
								 <label class="form-label"><h6>Et&agrave; figli</h6><span id="eta_figli_error_msg" style="color:red;"></span></label>
                                            <br/>
                                         
									<div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="si_figli_minorenni" value="Minorenni" name="eta_figli"  class="custom-control-input">
                                                <label class="custom-control-label" for="si_figli_minorenni" style="font-size:medium;">Minorenni</label>
                                            </div>
											<div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="no_figli_minorenni" value="Maggiorenni" name="eta_figli"  class="custom-control-input">
                                                <label class="custom-control-label" for="no_figli_minorenni" style="font-size:medium;">Maggiorenni</label>
                                            </div>
                                            -->
                    </div>
                    <div class="form-group">
                ...
                <form action="">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="form-group" id="accessi_ripetuti">
                    <label class="form-label"><span class="h6s">N&deg; accessi ripetuti</span>&nbsp;<span id="numero_accessi_ripetuti_error_msg" style="color: red;"></span></label> <br /> <input type="number" class="form-control" id="numero_accessi_ripetuti" value="1" min="1">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group" id="div_sfruttamento">
                    ...
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" class="custom-control-input" id="sfruttamento5" name="sfruttamento" value="Violenze/Maltrattamenti psicologici"> <label class="custom-control-label" for="sfruttamento5">Violenze/Maltrattamenti psicologici</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" class="custom-control-input" id="sfruttamento6" name="sfruttamento" value="Atti persecutori (Stalking)"> <label class="custom-control-label" for="sfruttamento6">Atti persecutori (Stalking)</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" class="custom-control-input" id="sfruttamento7" name="sfruttamento" value="Mobbing"> <label class="custom-control-label" for="sfruttamento7">Mobbing</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" class="custom-control-input" id="sfruttamento8" name="sfruttamento" value="Violenza economica"> <label class="custom-control-label" for="sfruttamento8">Violenza economica</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" class="custom-control-input" id="sfruttamento9" name="sfruttamento" value="Violenza sessuale"> <label class="custom-control-label" for="sfruttamento9">Violenza sessuale</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" class="custom-control-input" id="sfruttamento10" name="sfruttamento" value="Mutilazioni genitali"> <label class="custom-control-label" for="sfruttamento10">Mutilazioni genitali</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" class="custom-control-input" id="sfruttamento11" name="sfruttamento" value="Matrimonio forzato"> <label class="custom-control-label" for="sfruttamento11">Matrimonio forzato</label>
                    </div>
                  </div>
                  ...
                  <div class="form-group" id="div_altro_donnaAccompagnataInPS">
                    <div class="form-holder">
                      <span id="altroDonnaAccompagnataInPS_error_msg" style="color: red;"></span> <input type="text" placeholder="Specificare ...  (es. amici,marito ecc...)" id="altroDonnaAccompagnataInPS" class="form-control" style="font-size: medium;">
                    </div>
                  </div>
                  <div class="form-group" id="div_motivoAccessoInPS">
                    <div class="form-holder">
                      ...
                      <textarea class="form-control" id="motivoAccessoInPS" placeholder="La donna riferisce che ..." style="font-size: medium;"></textarea>
                    </div>
                  </div>
                  ...
                  <!-- div class="form-group">
                    <label class="form-label"><span class="h6s">Codice attribuito</span>&nbsp;<span id="codiceAttribuito_error_msg" style="color: red;"></span></label> <br />
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" id="verde_codice_attribuito" value="Verde" name="codiceAttribuito" class="custom-control-input"> <label class="custom-control-label" for="verde_codice_attribuito" style="font-size: medium;">Verde</label> &nbsp;
                      <div style="width: 20px; height: 20px; background: green;"></div>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" id="rosso_codice_attribuito" value="Rosso" name="codiceAttribuito" class="custom-control-input"> <label class="custom-control-label" for="rosso_codice_attribuito" style="font-size: medium;">Rosso</label> &nbsp;
                      <div style="width: 20px; height: 20px; background: red;"></div>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" id="giallo_codice_attribuito" value="Giallo" name="codiceAttribuito" class="custom-control-input"> <label class="custom-control-label" for="giallo_codice_attribuito" style="font-size: medium;">Giallo</label> &nbsp;
            ...
            <div class="card">
              <div class="card-body">
                <form action="">
                  ...
                  <div class="form-group">
                    <div class="form-holder">
                      <label class="form-label"><span class="h6s">Data di nascita</span>&nbsp;<span id="data_nascita_presunto_aggressore_error_msg" style="color: red;"></span></label>
                      <!-- 
											<input type="text" placeholder="Data di nascita (GG/MM/AAAA)"
												id="data_nascita_presunto_aggressore" class="form-control"  style="font-size:medium;">
												-->
                      <input id="data_nascita_presunto_aggressore" style="font-size: medium;" class="form-control" placeholder="gg/mm/aaaa" />
                      <script>
																							$(
                  ...
                  <!-- 
                            <div class="form-group" id="div_altroFasciaDiEtaAggressore">
										<div class="form-holder">
											<input type="text"  placeholder="Altro..." id="altroFasciaDiEtaAggressore"
												class="form-control" style="font-size:medium;">
										</div>
									</div>
									-->
            ...
            <div class="card">
              <div class="card-body">
                <form action="">
                  ...
                  <div class="form-group">
                    <label class="form-label"><span class="h6s">Escalation della violenza?</span>&nbsp;<span id="brief_risk_6_error_msg" style="color: red;"></span></label> <br />
                    <div class="custom-control custom-radio custom-control-inline">
                  ...
                  <div class="form-group">
                    <label class="form-label"><span class="h6s">Violazione misure cautelari interdittive?</span>&nbsp;<span id="brief_risk_7_error_msg" style="color: red;"></span></label> <br />
                    <div class="custom-control custom-radio custom-control-inline">
                  ...
                  <hr />
                  <label class="form-label h6s"><b>Invio ed attivazione della rete antiviolenza intra/extra ospedaliera</b></label>
                  ...
                  <div class="form-group" id="div_rete_extra_ospedaliera">
                    <label class="form-label"><span class="h6s">Extra ospedaliera</span>&nbsp;<span id="rete_extra_ospedaliera_error_msg" style="color: red;"></span></label> <select class="custom-select" id="rete_extra_ospedaliera">
                      ...
                      <option value="Centri antiviolenza">Centri antiviolenza</option>
