...
<script type="text/javascript">
	...
	function load() {
		...
		question14 = new Object();
		question14.action = "editDraft";
		question14.answer1 = "" + q_id;
		...
		var request = $
				.ajax({
					...
					type : "GET",
					data : {
						elements : JSON.stringify(question14)
					},
					dataType : "JSON",
					...
					success : function(jsonStr) {
						...
						Inizio qui
						 */
						$('#identificativo_scheda').val(identificativo_scheda);
						$('#id_scheda').val(identificativo_scheda);
						$('#data_compilazione').val(data_compilazione);
						$('#nome_compilatore').val(nomeCompilatore);
						$('#cognome_compilatore').val(cognomeCompilatore);

						if (ruoloCompilatore_select == ""
								|| ruoloCompilatore_select == undefined)
							$('#ruoloCompilatore_select').val("Scegli...");
						else
							$('#ruoloCompilatore_select').val(
									ruoloCompilatore_select);

						if (identificativoServizio_select == ""
								|| identificativoServizio_select == undefined)
							$('#identificativoServizio_select')
									.val("Scegli...");
						else
							$('#identificativoServizio_select').val(
									identificativoServizio_select);

						$('#altroIdentificativoServizio').val(
								altroIdentificativoServizio);

						if (prontosoccorso_select == ""
								|| prontosoccorso_select == undefined)
							$('#prontosoccorso_select').val("Scegli...");
						else
							$('#prontosoccorso_select').val(
									prontosoccorso_select);

						if (provincia_prontosoccorso_select == ""
								|| provincia_prontosoccorso_select == undefined)
							$('#provincia_prontosoccorso_select').val(
									"Scegli...");
						else
							$('#provincia_prontosoccorso_select').val(
									provincia_prontosoccorso_select);

						addComuniProntoSoccorso(comune_prontosoccorso_select);

						/*
						if (comune_prontosoccorso_select == ""
								|| comune_prontosoccorso_select == undefined)
							$('#comune_prontosoccorso_select').val("Scegli...");
						else
							$('#comune_prontosoccorso_select').val(
									comune_prontosoccorso_select);
						 */

						$('#cav_nome').val(cav_nome);

						if (provincia_cav_select == ""
								|| provincia_cav_select == undefined)
							$('#provincia_cav_select').val("Scegli...");
						else
							$('#provincia_cav_select')
									.val(provincia_cav_select);

						addComuniCAV(comune_cav_select);

						/*
						if (comune_cav_select == ""
								|| comune_cav_select == undefined)
							$('#comune_cav_select').val("Scegli...");
						else
							$('#comune_cav_select').val(comune_cav_select);
						 */

						if (sportelloDiAscolto_select == ""
								|| sportelloDiAscolto_select == undefined)
							$('#sportelloDiAscolto_select').val("Scegli...");
						else
							$('#sportelloDiAscolto_select').val(
									sportelloDiAscolto_select);

						$('#sportello_nome').val(sportello_nome);

						if (provincia_sportellodiascolto_select == ""
								|| provincia_sportellodiascolto_select == undefined)
							$('#provincia_sportellodiascolto_select').val(
									"Scegli...");
						else
							$('#provincia_sportellodiascolto_select').val(
									provincia_sportellodiascolto_select);

						addComuniSportelloDiAscolto(comune_sportellodiascolto_select);

						/*
						if (comune_sportellodiascolto_select == ""
								|| comune_sportellodiascolto_select == undefined)
							$('#comune_sportellodiascolto_select').val(
									"Scegli...");
						else
							$('#comune_sportellodiascolto_select').val(
						...
						if (luogo_select == "" || luogo_select == undefined)
							$('#luogo_select').val("Scegli...");
						else
							$('#luogo_select').val(luogo_select);

						if (provincia_nascita_select == ""
								|| provincia_nascita_select == undefined)
							$('#provincia_nascita_select').val("Scegli...");
						else
							$('#provincia_nascita_select').val(
									provincia_nascita_select);

						addComuni(comune_nascita_select);

						/*
						if (comune_nascita_select == ""
								|| comune_nascita_select == undefined)
							$('#comune_nascita_select').val("Scegli...");
						else
							$('#comune_nascita_select').val(
									comune_nascita_select);
						 */

						$('#indirizzo').val("");
						$('#telefono_personale').val("");
						$('#altro_telefono').val("");

						$(
								"input[name='cittadinanza'][value='"
										+ cittadinanza + "']").attr("checked",
								"true");

						if (cittadinanza_select == ""
								|| cittadinanza_select == undefined)
							$('#cittadinanza_select').val("Scegli...");
						else
							$('#cittadinanza_select').val(luogo_select);

						if (select_lingua_italiana == ""
								|| select_lingua_italiana == undefined)
							$('#select_lingua_italiana').val("Scegli...");
						else
							$('#select_lingua_italiana').val(
									select_lingua_italiana);

						$(
								"input[name='mediatoreCulturale'][value='"
										+ mediatoreCulturale + "']").attr(
								"checked", "true");

						if (statoCivile == "" || statoCivile == undefined)
							$('#statoCivile').val("Scegli...");
						else
							$('#statoCivile').val(statoCivile);

						$('#altrostatocivile').val(altrostatocivile);

						$("input[name='figli'][value='" + figli + "']").attr(
								"checked", "true");

						$('#numero_figli').val(numero_figli);
						$('#numero_figli_minorenni')
								.val(numero_figli_minorenni);
						$('#numero_figli_minorenni_maschi').val(
								numero_figli_minorenni_maschi);
						$('#numero_figli_minorenni_femmine').val(
								numero_figli_minorenni_femmine);

						$(
								"input[name='convivono_figliFemmine'][value='"
										+ convivono_figliFemmine + "']").attr(
								"checked", "true");
						$(
								"input[name='assistonoViolenza_figli'][value='"
										+ assistonoViolenza_figli + "']").attr(
								"checked", "true");
						$(
								"input[name='subisconoViolenza_figli'][value='"
										+ subisconoViolenza_figli + "']").attr(
								"checked", "true");

						if (selectTitoloDiStudio == ""
								|| selectTitoloDiStudio == undefined)
							$('#selectTitoloDiStudio').val("Scegli...");
						else
							$('#selectTitoloDiStudio')
									.val(selectTitoloDiStudio);

						$('#altroTitoloDiStudio').val(altroTitoloDiStudio);

						if (selectProfessione == ""
								|| selectProfessione == undefined)
							$('#selectProfessione').val("Scegli...");
						else
							$('#selectProfessione').val(selectProfessione);

						$('#altro_stato_occupazionale_donna').val(
								altro_stato_occupazionale_donna);

						$(
								"input[name='autonomo_economicamente'][value='"
										+ autonomo_economicamente + "']").attr(
								"checked", "true");

						$(
								"input[name='primo_accesso_servizio_antiviolenza'][value='"
										+ primo_accesso_servizio_antiviolenza
										+ "']").attr("checked", "true");

						$('#numero_accessi_ripetuti').val(
								numero_accessi_ripetuti);
						$(
								"input[name='accesso_occasionale'][value='"
										+ accesso_occasionale + "']").attr(
								"checked", "true");
						...
						$('#donnaaccompagnata_forzedellordine_select').val(
								donnaaccompagnata_forzedellordine_select);

						if (donnaaccompagnata_forzedellordine_select == ""
								|| donnaaccompagnata_forzedellordine_select == undefined)
							$('#donnaaccompagnata_forzedellordine_select').val(
									"Scegli...");
						else
							$('#donnaaccompagnata_forzedellordine_select').val(
						...
						if (provincia_donnaaccompagnata_forzedellordine_select == ""
								|| provincia_donnaaccompagnata_forzedellordine_select == undefined)
							$(
						...
						addComuniDonnaaccompagnata_forzedellordine(comune_donnaaccompagnata_forzedellordine_select);

						/*
						if (comune_donnaaccompagnata_forzedellordine_select == ""
								|| comune_donnaaccompagnata_forzedellordine_select == undefined)
							$(
						...
						if (donnaaccompagnata_prontosoccorso_select == ""
								|| donnaaccompagnata_prontosoccorso_select == undefined)
							$('#donnaaccompagnata_prontosoccorso_select').val(
									"Scegli...");
						else
							$('#donnaaccompagnata_prontosoccorso_select').val(
									donnaaccompagnata_prontosoccorso_select);

						if (provincia_donnaaccompagnata_prontosoccorso_select == ""
								|| provincia_donnaaccompagnata_prontosoccorso_select == undefined)
							$(
						...
						addComunidonnaaccompagnata_prontosoccorso(comune_donnaaccompagnata_prontosoccorso_select);

						/*
						if (comune_donnaaccompagnata_prontosoccorso_select == ""
								|| comune_donnaaccompagnata_prontosoccorso_select == undefined)
						...
						if (selectDonnaAccompagnataDaAltrePersoneInSA == ""
								|| selectDonnaAccompagnataDaAltrePersoneInSA == undefined)
						...
						$('#altroDonnaAccompagnataInPS').val(
								altroDonnaAccompagnataInPS);
						$('#motivoAccesso').val(motivoAccesso);

						if (selectTipologiaViolenza == ""
								|| selectTipologiaViolenza == undefined)
							$('#selectTipologiaViolenza').val("Scegli...");
						else
							$('#selectTipologiaViolenza').val(
									selectTipologiaViolenza);

						if (sfruttamento != null && sfruttamento != undefined) {
							var sfruttamentoItem = sfruttamento.split(';');

							for (var i = 0; i < sfruttamentoItem.length; i++) {
								$(
										"input[name='sfruttamento'][value='"
												+ sfruttamentoItem[i] + "']")
										.attr("checked", "true");
							}
						}

						if (violenzeRiferiteItem != null
								&& violenzeRiferiteItem != undefined) {
							var violenzeRiferiteItem = violenzeRiferite
									.split(';');

							for (var i = 0; i < violenzeRiferiteItem.length; i++) {
								$(
										"input[name='violenzeRiferite'][value='"
												+ violenzeRiferiteItem[i]
												+ "']").attr("checked", "true");
							}
						}

						$('#altroViolenzaRiferita').val(altroViolenzaRiferita);

						$(
								"input[name='conosci_aggressore'][value='"
										+ conosci_aggressore + "']").attr(
								"checked", "true");

						$('#nome_presunto_aggressore').val("");
						$('#cognome_presunto_aggressore').val("");
						$('#data_nascita_presunto_aggressore').val("");

						if (luogo_presunto_aggressore_select == ""
								|| luogo_presunto_aggressore_select == undefined)
							$('#luogo_presunto_aggressore_select').val(
									"Scegli...");
						else
							$('#luogo_presunto_aggressore_select').val(
									luogo_presunto_aggressore_select);

						if (provincia_nascita_presunto_aggressore_select == ""
								|| provincia_nascita_presunto_aggressore_select == undefined)
						...
						addComuniPresunto(comune_nascita_presunto_aggressore_select);

						/*
						if (comune_nascita_presunto_aggressore_select == ""
								|| comune_nascita_presunto_aggressore_select == undefined)
							...
							$('#comune_nascita_presunto_aggressore_select')
									.val(
											comune_nascita_presunto_aggressore_select);
						 */
						$('#indirizzo_presunto_aggressore').val("");
						$('#telefono_presunto_aggressore').val("");

						if (selectTitoloDiStudioAggressore == ""
								|| selectTitoloDiStudioAggressore == undefined)
							$('#selectTitoloDiStudioAggressore').val(
									"Scegli...");
						else
							$('#selectTitoloDiStudioAggressore').val(
									selectTitoloDiStudioAggressore);

						$('#altroTitoloDiStudioAggressore').val(
								altroTitoloDiStudioAggressore);

						if (selectProfessioneAggressore == ""
								|| selectProfessioneAggressore == undefined)
							$('#selectProfessioneAggressore').val("Scegli...");
						else
							$('#selectProfessioneAggressore').val(
									selectProfessioneAggressore);

						$('#altro_stato_occupazionale_aggressore').val(
								altro_stato_occupazionale_aggressore);

						if (fascia_di_eta_aggressore == ""
								|| fascia_di_eta_aggressore == undefined)
							$('#fascia_di_eta_aggressore').val("Scegli...");
						else
							$('#fascia_di_eta_aggressore').val(
									fascia_di_eta_aggressore);

						if (rapporto_vittima_autore_violenza == ""
								|| rapporto_vittima_autore_violenza == undefined)
							$('#rapporto_vittima_autore_violenza').val(
									"Scegli...");
						else
							$('#rapporto_vittima_autore_violenza').val(
									rapporto_vittima_autore_violenza);

						if (tipologia_familiare == ""
								|| tipologia_familiare == undefined)
							$('#tipologia_familiare').val("Scegli...");
						else
							$('#tipologia_familiare').val(tipologia_familiare);

						$('#altroRapportoVittimaAggressore').val(
								altroRapportoVittimaAggressore);

						$(
								"input[name='aggressore_servizi'][value='"
										+ aggressore_servizi + "']").attr(
								"checked", "true");

						if (tipologia_servizi_aggressore == ""
								|| tipologia_servizi_aggressore == undefined)
							$('#tipologia_servizi_aggressore').val("Scegli...");
						else
							$('#tipologia_servizi_aggressore').val(
									tipologia_servizi_aggressore);

						$('#altroTipologiaServiziAggressore').val(
								altroTipologiaServiziAggressore);

						$(
								"input[name='violenza_assistitaosubita'][value='"
										+ violenza_assistitaosubita + "']")
								.attr("checked", "true");

						$(
								"input[name='precedenti_penali'][value='"
										+ precedenti_penali + "']").attr(
								"checked", "true");

						$(
								"input[name='brief_risk_1'][value='"
										+ brief_risk_1 + "']").attr("checked",
								"true");

						$(
								"input[name='brief_risk_2'][value='"
										+ brief_risk_2 + "']").attr("checked",
								"true");

						$(
								"input[name='brief_risk_3'][value='"
										+ brief_risk_3 + "']").attr("checked",
								"true");

						$(
								"input[name='brief_risk_4'][value='"
										+ brief_risk_4 + "']").attr("checked",
								"true");

						$(
								"input[name='brief_risk_5'][value='"
										+ brief_risk_5 + "']").attr("checked",
								"true");

						$(
								"input[name='brief_risk_6'][value='"
										+ brief_risk_6 + "']").attr("checked",
								"true");

						$(
								"input[name='brief_risk_7'][value='"
										+ brief_risk_7 + "']").attr("checked",
								"true");

						$(
								"input[name='faseDiSeparazione'][value='"
										+ faseDiSeparazione + "']").attr(
								"checked", "true");

						$("input[name='separata'][value='" + separata + "']")
								.attr("checked", "true");

						if (tempo_separazione_select == ""
								|| tempo_separazione_select == undefined)
							$('#tempo_separazione_select').val("Scegli...");
						else
							$('#tempo_separazione_select').val(
									tempo_separazione_select);

						$(
								"input[name='haComunicatoAlPartner'][value='"
										+ haComunicatoAlPartner + "']").attr(
								"checked", "true");

						$(
								"input[name='sporgereDenuncia'][value='"
										+ sporgereDenuncia + "']").attr(
								"checked", "true");

						$(
								"input[name='sportoDenuncia'][value='"
										+ sportoDenuncia + "']").attr(
								"checked", "true");

						if (selectForzeDellOrdineDenuncia == ""
								|| selectForzeDellOrdineDenuncia == undefined)
							$('#selectForzeDellOrdineDenuncia')
									.val("Scegli...");
						else
							$('#selectForzeDellOrdineDenuncia').val(
									selectForzeDellOrdineDenuncia);

						if (provincia_denuncia_select == ""
								|| provincia_denuncia_select == undefined)
							$('#provincia_denuncia_select').val("Scegli...");
						else
							$('#provincia_denuncia_select').val(
									provincia_denuncia_select);

						addComuniDenuncia(comune_denuncia_select);

						/*
						if (comune_denuncia_select == ""
								|| comune_denuncia_select == undefined)
							$('#comune_denuncia_select').val("Scegli...");
						else
							$('#comune_denuncia_select').val(
									comune_denuncia_select);
						 */

						$(
								"input[name='ritiratoDenuncia'][value='"
										+ ritiratoDenuncia + "']").attr(
								"checked", "true");

						$('#motivoRitiroDenuncia_select').val(
								motivoRitiroDenuncia_select);

						if (motivoRitiroDenuncia_select == ""
								|| motivoRitiroDenuncia_select == undefined)
							$('#motivoRitiroDenuncia_select').val("Scegli...");
						else
							$('#motivoRitiroDenuncia_select').val(
									motivoRitiroDenuncia_select);

						if (valutazione_stato_bisogno != null
								&& valutazione_stato_bisogno != undefined) {
							var valutazione_stato_bisognoItem = valutazione_stato_bisogno
									.split(';');

							for (var i = 0; i < sfruttamentoItem.length; i++) {
								$(
										"input[name='valutazione_stato_bisogno'][value='"
												+ valutazione_stato_bisognoItem[i]
												+ "']").attr("checked", "true");
							}
						}
						...
						if (presaInCarico != null && presaInCarico != undefined) {
							var presaInCaricoItem = presaInCarico.split(';');

							for (var i = 0; i < presaInCaricoItem.length; i++) {
								$(
										"input[name='presaInCarico'][value='"
												+ presaInCaricoItem[i] + "']")
										.attr("checked", "true");
							}
						}

						if (prestazioniEffettuate != null
								&& prestazioniEffettuate != undefined) {
							var prestazioniEffettuateItem = prestazioniEffettuate
									.split(';');

							for (var i = 0; i < prestazioniEffettuateItem.length; i++) {
								$(
										"input[name='prestazioniEffettuate'][value='"
												+ prestazioniEffettuateItem[i]
												+ "']").attr("checked", "true");
							}
						}

						if (attivazioneRete_select == ""
								|| attivazioneRete_select == undefined)
							$('#attivazioneRete_select').val("Scegli...");
						else
							$('#attivazioneRete_select').val(
									attivazioneRete_select);

						if (attivazioneRete_prontosoccorso_select == ""
								|| attivazioneRete_prontosoccorso_select == undefined)
							$('#attivazioneRete_prontosoccorso_select').val(
									"Scegli...");
						else
							$('#attivazioneRete_prontosoccorso_select').val(
									attivazioneRete_prontosoccorso_select);

						if (attivazioneRete_provincia_prontosoccorso_select == ""
								|| attivazioneRete_provincia_prontosoccorso_select == undefined)
							$(
						...
						addComuniAttivazioneReteProntoSoccorso(attivazioneRete_comune_prontosoccorso_select);

						/*
						if (attivazioneRete_comune_prontosoccorso_select == ""
								|| attivazioneRete_comune_prontosoccorso_select == undefined)
						...
						if (attivazioneRete_forzedellordine_select == ""
								|| attivazioneRete_forzedellordine_select == undefined)
							$('#attivazioneRete_forzedellordine_select').val(
									"Scegli...");
						else
							$('#attivazioneRete_forzedellordine_select').val(
									attivazioneRete_forzedellordine_select);

						if (attivazioneRete_provincia_forzedellordine_select == ""
								|| attivazioneRete_provincia_forzedellordine_select == undefined)
							$(
						...
						addattivazioneRete_forzedellordine();

						if (attivazioneRete_comune_forzedellordine_select == ""
								|| attivazioneRete_comune_forzedellordine_select == undefined)
						...
						if (servizioSanitario_provincia_select == ""
								|| servizioSanitario_provincia_select == undefined)
							$('#servizioSanitario_provincia_select').val(
									"Scegli...");
						else
							$('#servizioSanitario_provincia_select').val(
									servizioSanitario_provincia_select);

						if (serviziSociali_provincia_select == ""
								|| serviziSociali_provincia_select == undefined)
							$('#serviziSociali_provincia_select').val(
									"Scegli...");
						else
							$('#serviziSociali_provincia_select').val(
	...
	function load_color_wizard() {
		...
		$('#button_question2')
				.removeClass('btn btn-rounded btn-secondary mb-3').addClass(
					...
					.ajax({
						...
						success : function(jsonStr) {
							...
							if (comune == "" || comune == undefined)
								...
								$('#comune_nascita_select').val(comune);
	...
	function addComuniAttivazioneReteProntoSoccorso(comune) {
	...
	function addComuniDenuncia(comune) {
					...
					.ajax({
						...
						success : function(jsonStr) {
							...
							if (comune == "" || comune == undefined)
								...
								$('#comune_denuncia_select').val(comune);
	...
	function addComunidonnaaccompagnata_prontosoccorso(comune) {
	...
	function addComuniDonnaaccompagnata_forzedellordine(comune) {
	...
	function addComuniSportelloDiAscolto(comune) {
	...
	function addComuniProntoSoccorso(comune) {
					...
					.ajax({
						...
						success : function(jsonStr) {
							...
							if (comune == "" || comune == undefined)
								...
								$('#comune_prontosoccorso_select').val(comune);
	...
	function addComuniPresunto(comune) {
			...
			if ($('#sportelloDiAscolto_select option:selected').text() != "Altro"
				...
				if ($('#sportello_nome').val() == "") {
					...
					if (re.test($('#sportello_nome').val())) {
						...
						$('#sportello_nome').css("border-color", "red");
						$("#sportello_nome_error_msg").text("Input non valido");
						flag = true;
					}
				}
  ...
  <div class="page-container">
    ...
    <div class="main-content">
          ...
          <div class="col-sm-8">
            <div class="breadcrumbs-area clearfix">
              ...
              <ul class="breadcrumbs pull-left">
                ...
                <li><span>Modifica Scheda</span></li>
              </ul>
            </div>
          </div>
      ...
      <div id="alertSend" class="alert alert-primary" role="alert" hidden="true">
        ...
        <hr>
        <div align="center">
          <input class="btn btn-rounded btn-primary mb-3" type="button" value="Conferma" onclick="confermaAlertSend();"> <input class="btn btn-rounded btn-primary mb-3" type="button" value="Salva come bozza" onclick="removeAlert();">
        </div>
      </div>
      <!-- page title area end -->
                ...
                <form action="">
                  ...
                  <div class="form-group" id="div_cav">
                    <div class="form-group" id="div_cav_nome">
                      <div class="form-holder">
                        <label class="form-label" style="font-size: medium;"><span class="h6s">Centro Antiviolenza</span>&nbsp;<span id="cav_nome_error_msg" style="color: red;"></span></label> <input type="text" placeholder="Centro Antiviolenza di" class="form-control" id="cav_nome" style="font-size: medium;">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="form-holder">
            ...
            <div class="card">
              <div class="card-body">
                <form action="">
                  ...
                  <div class="form-group">
                    <label class="form-label"><span class="h6s">Conosce il presunto autore della violenza?</span>&nbsp;</label> <br />
                    <div class="custom-control custom-radio custom-control-inline">
            ...
            <div class="card">
              <div class="card-body">
                <form action="">
                  ...
                  <br /> <label class="form-label h6s">Brief Risk Assessment for the Emergency Department (DA-5). Snider e Campbell, 2</label> <br />
                  <div class="form-group">
                  ...
                  <hr />
                  <div class="form-group">
                    <label class="text-muted mb-3 d-block"><span class="h6s">Presa in carico per:</span>&nbsp;<span id="presaInCarico_error_msg" style="color: red;"></span></label>
                    <div class="custom-control custom-checkbox">
                  ...
                  <div class="form-group" id="prestazioniEffettuate">
                    <hr />
                    <label class="form-label h6s">Prestazioni effettuate:<span id="prestazioniEffettuate_error_msg" style="color: red;"></span></label>
                    <div class="custom-control custom-checkbox">
                  ...
                  <hr />
                  <div class="form-group">
                    <label class="text-muted mb-3 d-block"><span class="h6s">Attivazione della Rete Territoriale Antiviolenza con invio a:</span>&nbsp;<span id="attivazioneRete_select_error_msg" style="color: red;"></span></label> <select class="custom-select" id="attivazioneRete_select">
                      <option value="Scegli..." selected>Scegli...</option>
          ...
          <div class="col-12 mt-5">
            <div class="card">
              <div class="card-body">
                <form action="">
                  <div class="form-group">
                    <button type="button" class="btn btn-secondary btn-lg btn-block" id="backbutton" onclick="indietro();">Indietro</button>
                    <button type="button" class="btn btn-success btn-lg btn-block" onclick="check();">Avanti</button>
                  </div>
                </form>
              </div>
            </div>
