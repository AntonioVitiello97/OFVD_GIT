...
<script type="text/javascript">
	...
	function load_data() {
		user.nome = $('#nomeUserCav').val();
		user.cognome = $('#cognomeUserCav').val();
		user.telefono = $('#telefonoUserCav').val();
		user.email = $('#emailUserCav').val();
		user.matricola = $('#matricolaUserCav').val();
		user.codeCav = $('#codeCav').val();
		user.codeAdminCav = $('#codeAdminCav').val();
		user.password = $('#passwordUserCav').val();
		user.newpassword = $('#newPasswordUserCav').val();
	}
	...
	function confermaAlertPassword() {
		var pass = document.getElementById('passwordUserCav').value;
		var newPass = document.getElementById('newPasswordUserCav').value;
		var tel = document.getElementById('telefonoUserCav').value;

		if (tel == "") {
			document.getElementById('alertDelete').removeAttribute('hidden');
			document.getElementById('mex').innerHTML = "Inserire un numero di telefono";
			window.scrollTo(0, 0);
			...
			if (pass != newPass) {
				...
				document.getElementById('mex').innerHTML = "Riempire il campo telefono!";
				window.scrollTo(0, 0);
	...
	function clean() {
		document.getElementById('passwordUserCav').value = "";
		document.getElementById('newPasswordUserCav').value = "";
	}
              ...
              <div class="card-body">
                <form action="">
                  ...
                  <div class="form-group">
                    <label>Nome</label> <input class="form-control" placeholder="<%=account.getNome()%>" readonly id="nomeUserCav" value="<%=account.getNome()%>"> 
                    <label>Cognome</label> <input class="form-control" placeholder="<%=account.getCognome()%>" readonly id="cognomeUserCav" value="<%=account.getCognome()%>"> 
                    <label>Telefono</label> <input class="form-control" placeholder="<%=account.getTelefono()%>" id="telefonoUserCav" value="<%=account.getTelefono()%>"> 
                    <label>Email</label> <input class="form-control" placeholder="<%=account.getEmail()%>" readonly id="emailUserCav" value="<%=account.getEmail()%>"> 
                    <label>Matricola</label> <input class="form-control" placeholder="<%=account.getMatricola()%>" readonly id="matricolaUserCav" value="<%=account.getMatricola()%>"> 
                    <label>Codice Servizio Antiviolenza</label> <input class="form-control" placeholder="<%=account.getCav()%>" readonly id="codeCav" value="<%=account.getCav()%>"> <label>
                    Codice Admin</label> <input class="form-control" placeholder="<%=account.getAdmin()%>" readonly id="codeAdminCav" value="<%=account.getAdmin()%>"> 
                    <label>Password</label> <input type="password" class="form-control" placeholder="Inserisci una nuova Password" id="passwordUserCav" value=""> 
                    <label>Ripeti Password</label> <input type="password" class="form-control" placeholder="Ripeti la nuova Password" id="newPasswordUserCav" value="">
                  </div>
                </form>
              </div>
            </div>
