...
<script type="text/javascript">
	...
	*/
	...
	var VariabiliArray = [
	    ...
	    new Variabile("Ruolo compilatore", "RuoloCompilatore" , "1", "0", "0"),
	    new Variabile("Altro ruolo compilatore", "AltroRuoloCompilatore" , "1", "0", "0"),
	    new Variabile("Identificativo servizio", "IdentificativoServizio" , "1", "0", "0"),
	    new Variabile("Altro identificativo servizio", "AltroIdentificativoServizio" , "1", "0", "0"),
	    new Variabile("Provincia pronto soccorso", "ProvinciaProntoSoccorso" , "1", "0", "0"),
	    
	    new Variabile("Comune pronto soccorso", "ComuneProntoSoccorso" , "1", "0", "0"),
	    new Variabile("Cav nome", "CavNome" , "1", "0", "0"),
	    new Variabile("Provincia cav", "ProvinciaCav" , "1", "0", "0"),
	    new Variabile("Comune cav", "ComuneCav" , "1", "0", "0"),
	    new Variabile("Sportello di ascolto", "SportelloDiAscolto" , "1", "0", "0"),
	    
	    new Variabile("Sportello nome", "SportelloNome" , "1", "0", "0"),
	    new Variabile("Provincia sportello di ascolto", "ProvinciaSportelloDiAscolto" , "1", "0", "0"),
	    new Variabile("Comune sportello di ascolto", "ComuneSportelloDiAscolto" , "1", "0", "0"),
	    new Variabile("Numero figli minorenni maschi", "NumeroFigliMinorenniMaschi" , "1", "0", "0"),
	    new Variabile("Numero figli minorenni femmine", "NumeroFigliMinorenniFemmine" , "1", "0", "0"),
	    
	    new Variabile("Convivono figli fimmine", "ConvivonoFigliFemmine" , "1", "0", "0"),
	    new Variabile("Assistono violenza", "AssistonoViolenza" , "1", "0", "0"),
	    new Variabile("Subiscono violenza figli", "SubisconoViolenzaFigli" , "1", "0", "0"),
	    new Variabile("Altro stato occupazionale donna", "AltroStatoOccupazionaleDonna" , "1", "0", "0"),
	    new Variabile("Accesso occasionale", "AccessoOccasionale" , "1", "0", "0"),
	    
	    new Variabile("Donna accompagnata al servizio anti violenza", "DonnaAccompagnataAlServizioAntiViolenza" , "1", "0", "0"),
	    new Variabile("Donna accompagnata forza dell'ordine", "DonnaAccompagnataForzaDellOrdine" , "1", "0", "0"),
	    new Variabile("Provincia donna accompagnata forza dell'ordine", "ProvinciaDonnaAccompagnataForzaDellOrdine" , "1", "0", "0"),
	    new Variabile("Comune donna accompagnata forza dell'ordine", "ComuneDonnaAccompagnataForzaDellOrdine" , "1", "0", "0"),
	    new Variabile("Tipologia violenza", "SelectTipologiaViolenza" , "1", "0", "0"),
	    
	    new Variabile("Violenze riferite", "ViolenzeRiferite" , "1", "0", "0"),
	    new Variabile("Altro violenze riferite", "AltroViolenzeRiferite" , "1", "0", "0"),
	    new Variabile("Conosci aggressore", "ConosciAggressore" , "1", "0", "0"),
	    new Variabile("Altro stato occupazionale aggressore", "AltroStatoOccupazionaleAggressore" , "1", "0", "0"),
	    new Variabile("Violenza assistita o subita", "ViolenzaAssistitaOsubita" , "1", "0", "0"),
	    
	    new Variabile("Fase di separazione", "FaseDiSeparazione" , "1", "0", "0"),
	    new Variabile("Separata", "Separata" , "1", "0", "0"),
	    new Variabile("Tempo separazione", "TempoSeparazione" , "1", "0", "0"),
	    new Variabile("Ha comunicato al partner", "HaComunicatoAlPartner" , "1", "0", "0"),
	    new Variabile("Sporgere denuncia", "SporgereDenuncia" , "1", "0", "0"),
	    
	    new Variabile("Sporto denuncia", "SportoDenuncia" , "1", "0", "0"),
	    new Variabile("Forze dell'ordine", "SelectForzeDellOrdine" , "1", "0", "0"),
	    new Variabile("Provincia denuncia", "ProvinciaDenuncia" , "1", "0", "0"),
	    new Variabile("Denuncia ritirata", "RitiratoDenuncia" , "1", "0", "0"),
	    new Variabile("Motivo ritiro denuncia", "MotivoRitiroDenuncia" , "1", "0", "0"),
	    
	    new Variabile("Valutazione stato bisogno", "ValutazioneStatoBisogno" , "1", "0", "0"),
	    new Variabile("Specificare altra valutazione stato bisogno", "SpecificareAltraValutazioneStatoBisogno" , "1", "0", "0"),
	    new Variabile("Presa in carico", "PresaInCarico" , "1", "0", "0"),
	    new Variabile("Prestazioni effettuate", "PrestazioniEffettuate" , "1", "0", "0"),
	    new Variabile("Attivazione rete", "AttivazioniRete" , "1", "0", "0"),
	    
	    new Variabile("Attivazione rete pronto soccorso", "AttivazioneReteProntoSoccorso" , "1", "0", "0"),
	    new Variabile("Attivazione rete provincia pronto soccorso", "AttivazioneReteProvinciaProntoSoccorso" , "1", "0", "0"),
	    new Variabile("Attivazione rete comune pronto soccorso", "AttivazioneReteComuneProntoSoccorso" , "1", "0", "0"),
	    new Variabile("Attivazione rete forze dell'ordine", "AttivazioneReteForzeDellOrdine" , "1", "0", "0"),
	    new Variabile("Attivazione rete provincia forze dell'ordine", "AttivazioneReteProvinciaForzeDellOrdine" , "1", "0", "0"),
	
	    new Variabile("Attivazione rete comune forze dell'ordine", "AttivazioneReteComuneForzeDellOrdine" , "1", "0", "0"),
	    new Variabile("Servizio sanitario provincia", "ServizioSanitarioProvincia" , "1", "0", "0"),
	    new Variabile("Servizi sociali provincia", "ServiziSocialiProvincia" , "1", "0", "0"),
	];
					...
					$('#variabile_select').change(
							function() 
							{
								...
								{	
									...
									chart_selezionato = 1;
									console.log("variabile_select Chart_Selezionato = "+chart_selezionato);
									addChart();
